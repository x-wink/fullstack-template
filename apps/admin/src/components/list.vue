<template>
  <div class="list-container">
    <div class="operation">
      <el-button v-if="props.allowCreate" :icon="Plus" type="primary" @click="handleCreate"
        >添加</el-button
      >
      <el-popconfirm
      ...
      <el-button v-if="props.allowExport" :icon="Download" type="success" @click="handleExport"
        >导出</el-button
      >
    </div>
